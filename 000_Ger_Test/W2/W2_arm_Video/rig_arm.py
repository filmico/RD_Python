...
# Create IK Control
# -----------------
arm_Ctrl = cmds.circle(n='ik_arm_Ctl', nr=(1, 0, 0), r=1, ch=0)
cmds.select(cl=True)
# Create Group
...
fk_arm_Ctrl = cmds.circle(n='fk_arm_Ctl', nr=(1, 0, 0), r=0.75, ch=0)
fk_forArm_Ctrl = cmds.circle(n='fk_foreArm_Ctl', nr=(1, 0, 0), r=0.75, ch=0)
cmds.select(cl=True)
# Create Groups
